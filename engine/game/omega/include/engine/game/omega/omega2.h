...
public:
    ...
    unsigned getLastMoveIdx() const;
    Omega2::ValidMoves getValidMoveIdxs() const;
    vector<Move> getValidMoves() const;
...
struct Group
{
    ...
    map<Omega2::Player, stack<list<unsigned>>> addedGroupIds;
...
struct Cell{
    ...
    list<unsigned> getNeighbourGroupIds(const vector<Group>& groups, Omega2::Player color) const;
