...
#include "../../../../../../ui/qt/omega/include/ui/qt/omega/canvas.h"
...
QT_MOC_LITERAL(1, 7, 15), // "updateGameState"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "Omega::Piece"
QT_MOC_LITERAL(4, 37, 15), // "mousePressEvent"
QT_MOC_LITERAL(5, 53, 12), // "QMouseEvent*"
QT_MOC_LITERAL(6, 66, 2) // "ev"

    },
    "Canvas\0updateGameState\0\0Omega::Piece\0"
    "mousePressEvent\0QMouseEvent*\0ev"
};
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateGameState((*reinterpret_cast< Omega::Piece(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
        ...
        {
            typedef void (Canvas::*_t)(Omega::Piece , unsigned  );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::updateGameState)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Canvas::updateGameState(Omega::Piece _t1, unsigned  _t2)
{
